package com.springbatchtasklet.springbatchdemo.util;
...
public class FileUtils {
    ...
    public Employee readLine() {
        try {
            ...
            return new Employee(data[0], LocalDate.parse(data[1], DateTimeFormatter.ofPattern("MM/dd/yyyy")));
        } catch (Exception e) {
    ...
    public void writeLine(Employee data) {
        try {
            ...
            logger.error("Error while writing emp data in file: {}", fileName);
        }
    }
